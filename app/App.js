  ...
  render() {
    return (
      <div className="site">
        <header>
          {this.state.loggedIn ? (
            <NavLink to="/gists" onlyActiveOnIndex={true} className="header--logo">Gist Manager</NavLink>
          ) : (
          <NavLink to="/" onlyActiveOnIndex={true} className="header--logo">Gist Manager</NavLink>
          )}
